    ...
    <div class="py-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div class="lg:col-span-2 bg-white border rounded-lg p-4">
                ...
                <form method="POST" action="{{ route('mobile.notifications.send') }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @csrf
                    <div class="space-y-3">
                        <div>
            ...
            <div class="bg-white border rounded-lg p-4">
                ...
                <form method="POST" action="{{ route('mobile.notifications.update_app') }}" class="mt-3">
                    @csrf
                    ...
                    <table class="min-w-full text-left">
                        ...
                        <tbody class="divide-y divide-gray-100 text-sm">
                            @foreach($notifications as $n)
                                <tr>
                                    <td class="px-4 py-2 text-gray-900">{{ $n->title }}</td>
                                    <td class="px-4 py-2 text-gray-700">{{ \Illuminate\Support\Str::limit($n->message, 90) }}</td>
                                    <td class="px-4 py-2 text-gray-600">{{ $n->scheduled_at?->format('Y-m-d H:i') ?? '—' }}</td>
                                    <td class="px-4 py-2">
