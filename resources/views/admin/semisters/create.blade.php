<x-admin-layout>
    <div class="py-4">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">Add New Semester</h1>
                <p class="text-sm text-gray-500">Create a new academic semester.</p>
            </div>
        ...
        <div class="mt-4 max-w-2xl">
            <form action="{{ route('admin.semisters.store') }}" method="POST" class="bg-white border rounded-lg p-6">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                                  ...
                                  placeholder="Additional information about this semester...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
